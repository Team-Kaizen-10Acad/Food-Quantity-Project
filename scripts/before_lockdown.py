...
def main(geoloc, lockdown_started, file_output):
    pass
    ...
    tweet_search.search_store(geoloc=geoloc, begin_date=False, end_date=lockdown_started, keywords=keywords, filter_keywords=filter_keywords, file_output=file_output)
...
if __name__ == '__main__':
    ...
    main(geoloc, lockdown_started, file_output)