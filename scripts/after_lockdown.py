...
def main(geoloc, lockdown_ended, file_output):
    pass
    ...
    tweet_search.search_store(geoloc=geoloc, begin_date=lockdown_ended, end_date=False, keywords=keywords, filter_keywords=filter_keywords, file_output=file_output)

if __name__ == '__main__':

    geoloc = sys.argv[1]
    lockdown_ended = sys.argv[2]
    file_output = sys.argv[3]

    main(geoloc, lockdown_ended, file_output)