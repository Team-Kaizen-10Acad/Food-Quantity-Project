...
def main(geoloc, first_case, file_output):
    ...
    tweet_search.search_store(geoloc=geoloc, begin_date=False, end_date=first_case, keywords=keywords, filter_keywords=filter_keywords, file_output=file_output)
